...
public class Prestamo {
     ...
     */
    public Prestamo(int idPrestamo, int idAsesor, int idCliente, String estadoPrestamo,
                    double monto, double interesGenerado, Date fechaPrestamo,
                    Date fechaVencimiento, double tasaInteres) {
